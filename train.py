# -*- coding: utf-8 -*-
"""4-veri_madenciligi_dunya_mutluluk_oranlari.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1mboTqdptJmAhxO3KVrHGAJ_2H4hrfFNp

Dünyada ki insanların mutluluk durumlarını ölçmek dünya mutluluk raporunun önemli bir çalışmasıdır.Alanında uzman ve söz sahibi insanlar refah ölçümleri ile ulusların ilerlemesini değerlendirmek ve bu raporları nasıl etkili bir şekilde kullanılabileceğini açıklamaktadır.Raporlar bugün bizlere mutluluk biliminin kişisel ve ulusal varyosyanlarını nasıl açıkladığını gösteriyor.

*Life Ladder:* Alt kısımda 0'dan üstte 10'a kadar numaralandırılmış basamaklara sahip bir merdiven düşünün. Merdivenin üst kısmı sizin için mümkün olan en iyi hayatı temsil eder ve merdivenin alt kısmı sizin için mümkün olan en kötü hayatı temsil eder.
